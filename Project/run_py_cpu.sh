...
singularity exec docker://unlhcc/tensorflow-gpu python -u -m pysc2.bin.agent --map MoveToBeacon --agent pysc2.agents.rl_agent.RlAgent --screen_resolution 64 --max_agent_steps 200000 $@
